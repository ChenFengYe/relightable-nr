# Thanks to https://github.com/S-aiueo32/contextual_loss_pytorch
...
class ContextualLoss(nn.Module):
    ...
    def __init__(self,
        ...
        if use_vgg:
            self.vgg_model = VGG19(vgg_model)
...
class VGG19(nn.Module):
    def __init__(self, vgg_pretrained_features, requires_grad=False):
