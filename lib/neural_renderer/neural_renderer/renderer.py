...
class Renderer(nn.Module):
    def __init__(self, image_size=256, anti_aliasing=True, background_color=[0,0,0],
        ...
        if self.camera_mode == 'projection' or self.camera_mode == 'orthogonal':
            self.K = K
            self.R = R
            self.t = t
            ...
            raise ValueError('Camera mode has to be one of projection, orthogonal, look or look_at')
    ...
    def render_silhouettes(self, vertices, faces, K=None, R=None, t=None, dist_coeffs=None, orig_size=None):
        ...
        if self.camera_mode == 'look_at':
            ...
            if orig_size is None:
                orig_size = self.orig_size
            vertices = nr.orthogonal(vertices, K, R, t, dist_coeffs, orig_size)
    ...
    def render(self, vertices, faces, textures, K=None, R=None, t=None, dist_coeffs=None, orig_size=None, offset = None, scale = None):
        ...
        if self.camera_mode == 'look_at':
            ...
            if scale is None:
                scale = self.scale
            vertices = nr.orthogonal(vertices, K, R, t, dist_coeffs, orig_size, offset = offset, scale = scale)
