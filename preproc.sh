...
python precompute.py --data_root ./data/synthesis_gai/ --obj_fp _/mesh/%03d.obj --calib_fp _/calib.mat --calib_format convert --img_dir _/rgb0 --gpu_id 0 --img_size 512 --only_mesh_related 0 --sampling_pattern all --multi_frame True
