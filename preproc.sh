...
python precompute.py --data_root ./data/realdome_cx/ \
--obj_fp _/mesh/%03d.obj \
--calib_fp _/calib.mat --calib_format convert \
--img_dir _/rgb0 \
--gpu_id 2 \
--img_size 512 \
--only_mesh_related 0 \
...
--multi_frame True
# --preset_uv_path /data/NFS/new_disk/chenxin/relightable-nr/data/realdome_cx/template_ca_smpl_uv.obj
